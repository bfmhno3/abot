...
BaseDriver::BaseDriver() : pn("~"), bdg(pn) {
  ...
  ROS_INFO("robot version:%s build time:%s",
...
void BaseDriver::init_cmd_odom() {
  ...
  cmd_vel_sub = nh.subscribe(bdg.cmd_vel_topic, 1000,
                             &BaseDriver::cmd_vel_callback, this);
  ...
  if (!bdg.publish_tf) {
    odom.pose.covariance = boost::assign::list_of(1e-3)(0)(0)(0)(0)(0)(0)(1e-3)(
        0)(0)(0)(0)(0)(0)(1e6)(0)(0)(0)(0)(0)(0)(1e6)(0)(0)(0)(0)(0)(0)(1e6)(0)(
        0)(0)(0)(0)(0)(1e3);

    odom.twist.covariance = boost::assign::list_of(1e-3)(0)(0)(0)(0)(0)(0)(
        1e-3)(0)(0)(0)(0)(0)(0)(1e6)(0)(0)(0)(0)(0)(0)(1e6)(0)(0)(0)(0)(0)(0)(
        1e6)(0)(0)(0)(0)(0)(0)(1e3);
  }
  ...
  // correct_pos_sub = nh.subscribe("correct_pos", 1000,
  // &BaseDriver::correct_pos_callback, this);
}

void BaseDriver::init_pid_debug() {
  if (bdg.out_pid_debug_enable) {
    const char* input_topic_name[MAX_MOTOR_COUNT] = {
        "motor1_input", "motor2_input", "motor3_input", "motor4_input"};
    const char* output_topic_name[MAX_MOTOR_COUNT] = {
        "motor1_output", "motor2_output", "motor3_output", "motor4_output"};
    for (size_t i = 0; i < MAX_MOTOR_COUNT; i++) {
      pid_debug_pub_input[i] =
          nh.advertise<std_msgs::Int32>(input_topic_name[i], 1000);
      pid_debug_pub_output[i] =
          nh.advertise<std_msgs::Int32>(output_topic_name[i], 1000);
    }
  }
}
...
void BaseDriver::read_param() {
  ...
  param->max_v_liner_x = 50;
  param->max_v_liner_y = 50;
  param->max_v_angular_z = 250;
  ...
  ROS_INFO("RobotParameters: %d %d %d %d %d %d %d %d %d %d %d %d %d",
           ...
           param->cmd_last_time, param->max_v_liner_x, param->max_v_liner_y,
           param->max_v_angular_z, param->imu_type);
...
void BaseDriver::work_loop() {
  ...
  while (ros::ok()) {
    ...
    if (Data_holder::get()->parameter.imu_type == 'E') update_imu();
