...
def airpub():
    pub_pose = rospy.Publisher("/abot/pose", PoseStamped, queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        orientation = (pose_msg.pose.orientation.x, pose_msg.pose.orientation.y, pose_msg.pose.orientation.z,
