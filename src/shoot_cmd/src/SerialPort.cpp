#include "../include/shoot_cmd/SerialPort.h"
#include <errno.h>
#include <fcntl.h>
#include <stdio.h>
#include <stdlib.h>
...
int speed_arr[] = {B1000000, B500000, B115200, B38400, B19200,
                   B9600,    B4800,   B2400,   B1200,  B300};
int name_arr[] = {1000000, 500000, 115200, 38400, 19200,
...
bool SerialPort::open(const char* portname, int baudrate, char parity,
                      char databit, char stopbit) {
...
bool SerialPort::set_Parity(int fd, int databits, int stopbits, int parity) {
  ...
  if ((parity != 'n') && (parity != 'N')) options.c_iflag |= INPCK;
